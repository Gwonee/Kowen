# Kowen
- Korean Qwen2-VL model (feat.[Qwen2-VL](https://github.com/QwenLM/Qwen2.5-VL), [LLaMA Factory](https://github.com/hiyouga/LLaMA-Factory))
- 이미지 기반 한국어 대화 가능한 멀티모달 모델

## Kowen Update
- 25.01.25
    - 한국어 Visual Instruction 데이터셋으로 학습한 [Kowen-vol-1-base-7B](https://huggingface.co/Gwonee/Kowen-vol-1-base-7B)

- 25.01.27
    - Kowen-vol-1-base-7B 모델에 한국적 이미지 데이터셋으로 학습한 [Kowen2-vol-1-7B](https://huggingface.co/Gr0o0vyHan/Kowen2-vol-1-7B)

- 25.02.05 ~
    - 모델 개선 후 업로드 예정

## Benchmark Test
- VARCO-VISION의 한국어 벤치마크와 K-viscuit 데이터셋으로 테스트를 진행했습니다.

| Aa Model Name                          | K-MMBench | K-Seed | K-MMStar | K-DTCBench | K-LLaVA | K-viscuit |
|----------------------------------------|-----------|--------|----------|------------|---------|-----------|
| VARCO-VISION-14B                       |  0.8221   | 0.7539 |  0.5733  |   0.8458   | 0.8474  |  0.8895   |
| Qwen2-VL-7B-Instruct                   |  0.7826   | 0.7408 |  0.5067  |   0.7500   | 0.6200  |           |
| Qwen2-VL (2B)                          |  0.4208   | 0.2729 |  0.2180  |   0.3167   |         |           |
| Qwen2-VL (7B)                          |  0.7449   | 0.6903 |  0.4100  |   0.7541   |         |  0.4779   |
| Kowen-vol-1-base-7B                    |  0.8328   | 0.7445 |  0.5280  |   0.7833   | 0.5520  |  0.6727   |
| Kowen2-vol-1-7B                        |  0.8292   | 0.7250 |  0.4953  |   0.8000   | 0.4090  |  0.7047   |

## train
- 상세 내용은 아래 LLaMA Factory 공식 깃허브를 참고하시면 됩니다.
```
llamafactory-cli train examples/train_lora/qwen2vl_lora_sft.yaml
```

## Inference
-  inference.py 내부 코드 중 이미지와 프롬프트를 수정 후 돌리시면 됩니다.
```
python inference.py
```

## Team
Kowen 프로젝트는 boostcamp AI Tech 7th 구성원들과 함께 진행했습니다.

팀원 : [Gwonhee](https://github.com/Gwonee), [Seungsoo](https://github.com/hanseungsoo13), [Yehna](https://github.com/yehna2907), [Hyunjin](https://github.com/sweetie-orange)
